...
class Settings(ctk.CTkFrame):
    ...
    # Wigets
        ...
        # Names
        self.txt1 = StickBottomTxtFrame(
            self, 'Settings File', TOP['STICKBOTTOMTXTFRAME']['SETTING']['FONT'], TOP['STICKBOTTOMTXTFRAME']['SETTING']['PADX'])
        self.txt2 = StickBottomTxtFrame(
            self, 'On/Off Key', TOP['STICKBOTTOMTXTFRAME']['ONOFFKEY']['FONT'], TOP['STICKBOTTOMTXTFRAME']['ONOFFKEY']['PADX'])
...
class FilePatch(ctk.CTkFrame):
    def __init__(self, parent):
        super().__init__(parent)
        self.configure(fg_color=TOP['FILEPATCH']['BG'],
                       corner_radius=TOP['FILEPATCH']['CORNERRADIUS'])
    ...
    # Wigets
        ...
        self.file_patch_entry.place(
            relx=0.04, rely=0, anchor='nw', relwidth=0.745, relheight=0.99)
        ...
        self.fliepatchbutton.place(
            relx=0.8, rely=0.2, anchor='nw', relwidth=0.14, relheight=0.6)
...
class OnOffButton(ctk.CTkButton):
    def __init__(self, parent):
        super().__init__(parent)
        # IMG
        self.img0 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['ONOFFBUTTON0']), size=TOP['ONOFFBUTTON']['IMGSIZE'])
        self.img1 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['ONOFFBUTTON1']), size=TOP['ONOFFBUTTON']['IMGSIZE'])
    ...
    def SetState(self):
        ...
        if state:
            self.configure(image=self.img1, fg_color=TOP['ONOFFBUTTON']
                           ['ON']['BG'], hover_color=TOP['ONOFFBUTTON']['ON']['HOVER'])
        else:
            self.configure(image=self.img0, fg_color=TOP['ONOFFBUTTON']
                           ['OFF']['BG'], hover_color=TOP['ONOFFBUTTON']['OFF']['HOVER'])
...
class ChangeKeyFrame(ctk.CTkFrame):
    ...
    def esc(self):
        self.esc = ctk.CTkLabel(self, text='Press ESC to leave',
                                font=OTHERS['CHANGEKEY']['FONT0'], text_color=OTHERS['CHANGEKEY']['TXTCOL'])
        self.esc.place(anchor='nw', relx=0.01, rely=0)

    def ClickKey(self):
        self.ClickKey = ctk.CTkLabel(self, text='...Press any button...',
                                     font=OTHERS['CHANGEKEY']['FONT1'], text_color=OTHERS['CHANGEKEY']['TXTCOL'])
...
class StickBottomTxtFrame(ctk.CTkFrame):
    def __init__(self, parent, txt, font, padx=0):
        ...
        self.label = ctk.CTkLabel(
            self, text=txt, font=font, text_color=TOP['STICKBOTTOMTXTFRAME']['TXTCOL'], padx=padx)
...
class Option(ctk.CTkButton):
    ...
    def MouseMove(self):
        ...
        self.img0 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['MOUSEMOVE0']), size=MID['OPTION']['IMGSIZE'])
        self.img1 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['MOUSEMOVE1']), size=MID['OPTION']['IMGSIZE'])
    ...
    def MouseButton(self):
        ...
        self.img0 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['MOUSEBUTTON0']), size=MID['OPTION']['IMGSIZE'])
        self.img1 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['MOUSEBUTTON1']), size=MID['OPTION']['IMGSIZE'])
        self.img2 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['MOUSEBUTTON2']), size=MID['OPTION']['IMGSIZE'])
        self.img3 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['MOUSEBUTTON3']), size=MID['OPTION']['IMGSIZE'])
    ...
    def Keyboard(self):
        ...
        self.img0 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['KEYBOARD0']), size=MID['OPTION']['IMGSIZE'])
        self.img1 = ctk.CTkImage(dark_image=Image.open(
            IMAGES['KEYBOARD1']), size=MID['OPTION']['IMGSIZE'])
    ...
    def MouseClick(self):
        ...
        match self.WigetState:
            case 0:
                self.configure(fg_color=MID['OPTION']['OFF']['BG'],
                               image=self.img0, hover_color=MID['OPTION']['OFF']['HOVER'])
            case 1:
                self.configure(fg_color=MID['OPTION']['ON']['BG'],
                               image=self.img1, hover_color=MID['OPTION']['ON']['HOVER'])
            case 2:
                self.configure(fg_color=MID['OPTION']['ON']['BG'],
                               image=self.img2, hover_color=MID['OPTION']['ON']['HOVER'])
            case 3:
                self.configure(fg_color=MID['OPTION']['ON']['BG'],
                               image=self.img3, hover_color=MID['OPTION']['ON']['HOVER'])
...
class Bottom(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.TimeCooldown.grid(
            column=1, row=2, sticky='nswe', pady=BOTTOM['PADY'])
        self.ResetTime.grid(column=1, row=3, sticky='nswe',
                            pady=BOTTOM['PADY'])
        self.ResetTimeRand.grid(
            column=1, row=4, sticky='nswe', pady=BOTTOM['PADY'])
        self.FPS.grid(column=1, row=5, sticky='nswe', pady=BOTTOM['PADY'])
        self.Range.grid(column=3, row=0, sticky='nswe', pady=BOTTOM['PADY'])
        self.Randomness.grid(
            column=3, row=1, sticky='nswe', pady=BOTTOM['PADY'])
        self.ClickNumber.grid(
            column=3, row=2, sticky='nswe', pady=BOTTOM['PADY'])
        self.Cooldown.grid(column=3, row=3, sticky='nswe', pady=BOTTOM['PADY'])
        self.Keys.grid(column=3, row=4, sticky='nswe', pady=BOTTOM['PADY'])
        self.InicialCooldown.grid(
            column=3, row=5, sticky='nswe', pady=BOTTOM['PADY'])
